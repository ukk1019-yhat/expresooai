    ...
    <div className="min-h-screen bg-[#0a0a0f] py-8 sm:py-16 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="flex items-center gap-2 mb-8 sm:mb-10">
          ...
          <span className="text-zinc-500 text-sm">Doc Analysis</span>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-2 sm:gap-3 mb-8 sm:mb-12">
          {[
            ...
            <div
              key={f.label}
              className="flex items-center gap-2 px-3 sm:px-4 py-2 rounded-full bg-zinc-900 border border-zinc-800 text-zinc-400 text-xs font-medium"
            >
        ...
        {/* Footer note */}
        <p className="text-center text-xs text-zinc-700 mt-8 sm:mt-10">
