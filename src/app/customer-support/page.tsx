  ...
  return (
    <div className="min-h-screen bg-[#fdfbf7] pt-32 pb-24 px-6 flex items-center justify-center">
      <div className="max-w-3xl w-full text-center">
        ...
        <h1 className="text-4xl md:text-6xl font-bold text-[#2c1e16] mb-6">Customer Support Training</h1>
        <p className="text-xl text-[#6e5646] mb-12">
          Simulate irate customers and complex edge cases to build empathy and de-escalation skills safely.
        </p>
        <a 
