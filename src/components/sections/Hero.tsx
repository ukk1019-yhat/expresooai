        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-4 mt-2">
            <Link
              ...
              className="inline-flex items-center justify-center gap-2 bg-[#704823] text-white px-6 py-3.5 rounded-lg font-semibold hover:bg-[#8b5a2b] transition-colors shadow-lg shadow-orange-600/20"
            >
        ...
        >
          <div className="glass-card p-6 relative z-10 shadow-2xl shadow-black/50">
            ...
            <div className="space-y-4 mb-6">
              ...
              <div className="bg-[#8b5a2b]/10 p-4 rounded-lg border border-[#8b5a2b]/20 ml-6 relative">
