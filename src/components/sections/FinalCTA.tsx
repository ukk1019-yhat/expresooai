    ...
    <section className="py-32 bg-[#fdfbf7] relative border-t border-[#e3d5c1] overflow-hidden" id="contact">
      ...
      <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
        ...
        >
          ...
          <p className="text-lg text-[#6e5646] mb-10 max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link 
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-[#704823] text-white px-8 py-4 rounded-lg font-semibold hover:bg-[#8b5a2b] transition-colors shadow-lg shadow-orange-600/20"
            >
