...
export function Footer() {
  return (
    <footer className="bg-[#fdfbf7] border-t border-[#e3d5c1] pt-20 pb-10">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8 mb-16">
          <div className="md:col-span-1">
            ...
            <div className="flex items-center gap-4 text-[#826a57]">
              ...
              <a href="https://www.linkedin.com/in/chokkapu-uma-krishna-kanth-50a502288/" target="_blank" rel="noopener noreferrer" className="hover:text-[#2c1e16] transition-colors">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path><rect x="2" y="9" width="4" height="12"></rect><circle cx="4" cy="4" r="2"></circle></svg>
                <span className="sr-only">LinkedIn</span>
              </a>
              <a href="#" className="hover:text-[#2c1e16] transition-colors">
        ...
        <div className="pt-8 border-t border-[#e3d5c1] flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            ...
            <Link href="#" className="text-xs text-[#967f6c] hover:text-[#6e5646]">Terms of Service</Link>
            <div className="flex items-center gap-2 px-3 py-1 bg-white/5 rounded-full border border-[#d4c3ab]">
              <div className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse"></div>
              <span className="text-xs text-[#6e5646] font-medium">All systems operational</span>
            </div>
          </div>
        </div>
      </div>
